...
class MenuViewController{
    ...
    static let radioVC          = UINavigationController(rootViewController: RadioViewController())
    static let quranVC          = UINavigationController(rootViewController: QuranViewController())
