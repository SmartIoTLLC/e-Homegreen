...
class DefaultDeviceImages: NSObject {
    ...
    func returnImagesArrayDependingOnCategoryId(_ categoryId: NSNumber, controlMode: Int?) -> [DeviceImageState] {
        ...
        case CategoryId.RelayControl:
            guard let controlModeTemp = controlMode else { return applianceImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return applianceImagesTwoStateNC
            } else { return applianceImagesTwoStateNO }
            
        case CategoryId.ClimateControl:
            guard let controlModeTemp = controlMode else { return climateImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return climateImagesTwoStateNC
            } else { return climateImagesTwoStateNO }
        ...
        case CategoryId.Curtain:
            guard let controlModeTemp = controlMode else { return curtainImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return curtainImagesTwoStateNC
            } else { return curtainImagesTwoStateNO }
            
        case CategoryId.Security:
            guard let controlModeTemp = controlMode else { return securityImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return securityImagesTwoStateNC
            } else { return securityImagesTwoStateNO }
            
        case CategoryId.Timer:
            guard let controlModeTemp = controlMode else { return timerImagesTwostateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return timerImagesTwostateNC
            } else { return timerImagesTwostateNO }
            
        case CategoryId.Flag:
            guard let controlModeTemp = controlMode else { return flagImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return flagImagesTwoStateNC
            } else { return flagImagesTwoStateNO }
            
        case CategoryId.Event:
            guard let controlModeTemp = controlMode else { return eventImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return eventImagesTwoStateNC
            } else { return eventImagesTwoStateNO }
            
        case CategoryId.Media:
            guard let controlModeTemp = controlMode else { return mediaImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return mediaImagesTwoStateNC
            } else { return mediaImagesTwoStateNO }
            
        case CategoryId.Blind:
            guard let controlModeTemp = controlMode else { return blindImagesTwoStateNO }
            if DigitalInput.modeInfo[controlModeTemp] == DigitalInput.ButtonNormallyClosed.description() || DigitalInput.modeInfo[controlModeTemp] == DigitalInput.NormallyClosed.description() { return blindImagesTwoStateNC
            } else { return blindImagesTwoStateNO }
            
        default: return applianceImagesTwoStateNO
        }
    }
}
