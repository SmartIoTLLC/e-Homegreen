...
class TestTestTest:NSObject {
    lazy var applicationPrivateDocumentsDirectory: NSURL = {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MasterDatabase", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationPrivateDocumentsDirectory.URLByAppendingPathComponent("MasterDatabase.sqlite")
