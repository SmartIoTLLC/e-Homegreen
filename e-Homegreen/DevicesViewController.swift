...
class DevicesViewController: PopoverVC{
    ...
    fileprivate func startRefreshTimer() {
        refreshTimer = Foundation.Timer.scheduledTimer(timeInterval: 30, target: self, selector: #selector(refreshVisibleDevicesInScrollView), userInfo: nil, repeats: true)
    }
