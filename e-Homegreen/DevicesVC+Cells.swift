...
extension DevicesVC: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if device.isEnabled.boolValue {
            if device.controlType == ControlType.Climate {
                ...
                deviceCollection.reloadItems(at: [indexPath])
            }
        }
    }
}
...
extension DevicesVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case ControlType.Dimmer : // MARK: - Device cell
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "deviceCollectionViewCell", for: indexPath) as? DeviceCollectionViewCell {
                print("device cell at:", indexPath.row)
                ...
                if device.isEnabled.boolValue {
                    ...
                    cell.picture.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(DevicesVC.oneTap(_:))))
                }
                
                return cell
            }
        case ControlType.Curtain: // MARK: - Curtain cell
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "curtainCollectionViewCell", for: indexPath) as? CurtainCollectionViewCell {
                cell.setCell(device: device, tag: tag)
                ...
                if device.isEnabled.boolValue {
                    ...
                    let curtainNameLongPress:UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(DevicesVC.cellParametarLongPress(_:)))
        ...
        case ControlType.SaltoAccess: // MARK: Salto Access cell
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "saltoAccessCollectionViewCell", for: indexPath) as? SaltoAccessCollectionViewCell {
                cell.setCell(device: device, tag: tag)
        ...
        case ControlType.Relay, ControlType.DigitalOutput: // MARK: - Appliance cell
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "applianceCollectionViewCell", for: indexPath) as? ApplianceCollectionViewCell {
                cell.setCell(device: device, tag: tag)
        ...
        case ControlType.Climate: // MARK: - Climate cell
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "climateCollectionViewCell", for: indexPath) as? ClimateCollectionViewCell {
        ...
        case ControlType.Sensor, ControlType.IntelligentSwitch, ControlType.Gateway, ControlType.DigitalInput: // MARK: - MultiSensor cell
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "multisensorCollectionViewCell", for: indexPath) as? MultisensorCollectionViewCell {
        ...
        default:
            if let cell = deviceCollection.dequeueReusableCell(withReuseIdentifier: "defaultDeviceCollectionViewCell", for: indexPath) as? DefaultDeviceCollectionViewCell {
